...
This is a lead generation project that integrates with n8n workflow automation. The project uses the n8n MCP (Model Context Protocol) server to interact with n8n workflows hosted at `ai.mokadijital.com`.

## MCP Integration

The project is configured with an n8n MCP server that provides tools for:
- Searching and managing n8n nodes
- Creating, updating, and validating workflows
- Deploying templates and managing workflow executions
- Workflow version control and rollback

Use the n8n MCP tools (prefixed with `mcp__n8n-mcp__`) to interact with the n8n instance for workflow automation tasks.
